...
from app.api.deps import CurrentAdmin, CurrentPrincipal, Trace, Uow, get_document_service
...
from app.schemas.document import DocumentDetail, DocumentOut, UploadResponse, VersionOut
...
async def list_documents(
    ...
    """Documents visible to the caller: their location's, plus organization-wide."""
    scope = principal.tenant.narrowed_to(location_id or principal.location_id)
